...
public class SwaggerUserController {
    private static final Logger logger = LoggerFactory.getLogger(SwaggerUserController.class);

    @Autowired
    private SwaggerUserService swaggerUserService;
    ...
    @GetMapping(value = "/v5")
    public SwaggerUser v5(String username) {
        return swaggerUserService.getUser(username);
    }
}
