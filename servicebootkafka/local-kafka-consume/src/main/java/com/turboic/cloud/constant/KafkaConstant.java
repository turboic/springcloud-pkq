...
public class KafkaConstant {
    ...
    public static final String customer_topic = "test";
    public static final int OUSHU = 2;
    public static final String CLIENT_ID_CONFIG = "kafka-client-liebe";
    public static final String CUSTOMER_CLIENT_ID_CONFIG = "customer-kafka-client-liebe";
