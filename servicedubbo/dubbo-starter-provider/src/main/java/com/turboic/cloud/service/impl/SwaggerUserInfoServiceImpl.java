...
public class SwaggerUserInfoServiceImpl implements SwaggerUserInfoService {
    private static final Logger log = LoggerFactory.getLogger(SwaggerUserInfoServiceImpl.class);


    @Override
    public SwaggerUserInfo getUser(String username) {
        SwaggerUserInfo swaggerUser = new SwaggerUserInfo(username,"dubbo");
